...
file on disk (next to this file) and injected into EmesGPT's system prompt on
...
TEACHINGS_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "teachings.json")
